                ...
                <Row className='gx-0'>
                            ...
                            <Row className='my-5 justify-content-center'>
                                <Col md={9} lg={9} xs={12} className='main-content'>
                                    ...
                                    <Form className='mt-5' onSubmit={signUpWithEmail}>
                                        ...
                                        <Form.Control type='tel' className='mb-4' placeholder='confirm password' value={password} onChange={(e) => setMobile(e.target.value)} required></Form.Control>
                    ...
                    <Col md={6}>
                        <div className='signup-right-card p-4'>
                            ...
                            {/* <img className='background p-4' src="https://static.vecteezy.com/system/resources/previews/003/689/228/original/online-registration-or-sign-up-login-for-account-on-smartphone-app-user-interface-with-secure-password-mobile-application-for-ui-web-banner-access-cartoon-people-illustration-vector.jpg"></img> */}
                        </div>
                    </Col>
                </Row>
            </Container>
